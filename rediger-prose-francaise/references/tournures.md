...
Calques de l'anglais que l'IA emploie sans réfléchir. Remplace par le verbe ou la formule française.

| Calque | Français |
| --- | --- |
| implémenter | mettre en place, appliquer, déployer |
| supporter (une fonctionnalité) | prendre en charge |
| adresser (un problème) | traiter, régler |
| délivrer (de la valeur) | apporter, livrer |
| faire sens | avoir du sens, être cohérent, être logique |
| en charge de | chargé de |
| à date | à ce jour, pour l'instant |
| basé sur | fondé sur, à partir de |
| en termes de | pour, sur, côté |
| au niveau de | pour, dans, sur |
| opportunité (sens d'occasion) | occasion |
| supporter une charge | tenir, soutenir |
| initier (un projet) | lancer, démarrer |
...
Mots français qui ressemblent à un mot anglais mais qui ont un sens différent. L'IA bascule souvent sur le sens anglais.

| Mot français | Sens français correct | Sens anglais à éviter |
| --- | --- | --- |
| définitivement | pour de bon, sans retour | _definitely_ (= certainement) |
| éventuellement | peut-être, le cas échéant | _eventually_ (= finalement) |
| réaliser | accomplir, mener à bien | _to realize_ (= se rendre compte) |
...
| Calque | Préférer |
| --- | --- |
| impacter | toucher, affecter, peser sur |
| solutionner | résoudre |
| disrupter | bouleverser, perturber |
| performer | atteindre, réussir, briller |
| finaliser | achever, conclure, mettre au point |
| prioriser | hiérarchiser, classer par priorité |
| digitaliser | numériser |
| matcher | correspondre, s'accorder |
| challenger (verbe) | contester, défier, mettre à l'épreuve |
| switcher | basculer, changer |
| pusher | pousser, mettre en avant |
...
Aucun n'est interdit, mais leur densité trahit la machine. Vise un connecteur par paragraphe.
...
| se révéler | être |
| s'avérer | être |
| témoigner de | montrer, indiquer |
| refléter | montrer |
| incarner | être, illustrer |
| disposer de | avoir |
| effectuer | faire |
...
L'IA aime annoncer des bouleversements abstraits.

- réinventer
- repenser
- redéfinir
- révolutionner
- transformer (sans dire en quoi)
- bouleverser
- réimaginer
- réenchanter
...
| --- | --- |
| à travers | par, via |
| dans le cadre de | pour, pendant |
| au cœur de | au centre de, dans |
| au regard de | face à, vu |
| à l'aune de | selon, comparé à |
...
Souvent jargonneuses et typiques de l'IA. Remplace par du français courant.
...
- voire même (voire suffit)
- au jour d'aujourd'hui (aujourd'hui)
- comme par exemple (comme, ou bien par exemple)
