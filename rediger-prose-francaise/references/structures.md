...
Créent une fausse tension. Énonce le second terme, éventuellement nuancé par une subordonnée concessive.
...
Verbes transformés en noms abstraits, souvent enchaînés en complément de nom. Remets le verbe, en subordonnée si nécessaire pour garder la phrase fluide.

| Lourd | Léger |
| --- | --- |
| la mise en œuvre de X | mettre en œuvre X, faire X |
| la prise en compte de X par Y | que Y prenne en compte X |
| l'optimisation de X | optimiser X, accélérer X, réduire X |
| la réalisation de X | faire X, mener X |
| l'utilisation de X | utiliser X |
| la compréhension de X | comprendre X |
| dans le cas d'une augmentation de Y | si Y augmente, lorsque Y augmente |
| la mise à disposition de X aux utilisateurs | donner accès à X aux utilisateurs |
...
| --- | --- |
| le fait que X | que X |
| dans la mesure où | car, puisque |
| pour ce qui est de X | pour X, sur X |
| en ce qui concerne X | sur X |
| par rapport à X | à X, pour X |
| à partir du moment où | dès que, lorsque |
| dans l'objectif de | pour |
| de manière à ce que | pour que |
...
### Après, paragraphe articulé

La solution est à la fois rapide et fiable, et l'équipe la prend en main sans formation lourde.

## Répétitions lexicales et syntaxiques

Le français écrit accepte mal la répétition à courte distance, là où l'anglais s'en accommode. L'IA tend pourtant à reprendre le même mot d'une phrase à l'autre, voire dans la même phrase, par paresse de variation.
...
| faire | mener, accomplir, réaliser au sens d'achever, mettre en œuvre |
| permettre | rendre possible, ouvrir la voie à, autoriser |
...
| Lourd | Léger |
| --- | --- |
| Il faut que vous compreniez | Vous devez comprendre |
| Je veux que vous partiez | Je veux votre départ, je souhaite votre départ |
| Il est important que vous lisiez | Lisez, vous devez lire |
| Nous proposons que l'équipe valide | Nous proposons à l'équipe de valider |
...
Le français écrit les titres en casse de phrase, seule la première lettre et les noms propres prennent une capitale. La casse de titre anglaise, qui capitalise chaque mot important, est un calque.
...
| Otan, Unesco, Osint | comme un mot, terme propre | initiale capitale |
| laser, radar, sida | comme un mot, nom commun | minuscules |

### Ponctuation des listes verticales

Une liste à puces introduite par un deux-points suit une ponctuation réglée. Chaque item commence par une minuscule, se termine par un point-virgule, et le dernier item se clôt par un point. Réserve la majuscule initiale et le point final par item aux listes de phrases complètes.
...
Erreurs courantes que l'IA reproduit, parfois parce qu'elles existent à l'oral mais restent fautives en registre soigné.
